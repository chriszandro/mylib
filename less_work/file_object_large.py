...
medium_heat_MMenvMM_0 = analysis.heatmap(heatmap=file_medium_heatmap_MMenvMM , primary_grid=file_medium_prim, secondary_grid=file_medium_sec, shift = medium_symmetric)
...
medium_heat_pos_MMenvMM_0 = analysis.heatmap(heatmap=file_medium_heatmap_pos_MMenvMM, primary_grid=file_medium_prim, secondary_grid=file_medium_sec, shift = medium_symmetric)
