...
if myhost=="lima" or myhost=="cshpc":
    ...
    path_rrze = "/user/chriz/expokit_heatmaps_2"
    projectpath =  "/user/chriz/expokit_heatmaps_2"    
...
for gate_end in gate_end_list: 
    ...
    # Grap Data
    path = "/user/chriz/Dropbox/expokit_work1_2/"
    if not os.path.exists(path):
        os.makedirs(path)

    result_evo = "/user/chriz/expokit_heatmaps_2/switch/result/inputfile_switchtest.inp_FeBo__exptime.evo"
